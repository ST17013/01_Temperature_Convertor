...
class Converter:
    def __init__(self, parent):
        ...
        self.history_button = Button(self.converter_frame, bg=background_color, text="History", font=("Arial", "14"), padx=10, pady=10, command=self.history)
...
class History:
    def __init__(self, partner):
        ...
        #History Label (row 2)
        self.history_label = Label(self.history_frame, text="History will display here...", bg=background, font=("Arial", "12"))
